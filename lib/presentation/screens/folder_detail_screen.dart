...
class _FolderDetailScreenState extends State<FolderDetailScreen> {
  ...
  void initState() {
    ...
    _snapshotFuture = _folderDetailService.loadCell(widget.cellId);
  }
...
class _FolderAssetCard extends StatelessWidget {
  const _FolderAssetCard({required this.item, required this.thumbnailService});
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: explanation == null && classificationOutcome == null
            ? null
            : () => _showExplanationSheet(context, item),
        child: Ink(
          decoration: BoxDecoration(
